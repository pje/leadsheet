    ...
    alteration_no_parens: [
      ...
      [
        ...
        [
          ...
          [
            "alt",
            { sourceInterval: [2062, 2075] },
            ["app", { sourceInterval: [2062, 2068] }, "extent", []],
            ["app", { sourceInterval: [2071, 2075] }, "root", []],
          ],
        ],
        [
          "seq",
...
result.Song = makeRecipe([
  ...
  "ChordExp",
  {
    ...
    metadata: [
      "define",
      { sourceInterval: [80, 166] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [95, 166] },
        ["app", { sourceInterval: [97, 106] }, "metaTitle", []],
        ["app", { sourceInterval: [113, 123] }, "metaArtist", []],
        ["app", { sourceInterval: [130, 138] }, "metaYear", []],
        ["app", { sourceInterval: [145, 152] }, "metaKey", []],
        ["app", { sourceInterval: [159, 166] }, "metaSig", []],
      ],
    ],
    metaTitle: [
      "define",
      { sourceInterval: [170, 244] },
      null,
      [],
      [
        "seq",
        { sourceInterval: [183, 244] },
        [
          "app",
          { sourceInterval: [183, 208] },
          "caseInsensitive",
          [["terminal", { sourceInterval: [199, 207] }, "title:"]],
        ],
        [
          "star",
          { sourceInterval: [210, 220] },
          ["app", { sourceInterval: [210, 219] }, "spaceNoNL", []],
        ],
        ["app", { sourceInterval: [221, 235] }, "metaTitleValue", []],
        ["app", { sourceInterval: [237, 244] }, "newline", []],
      ],
    ],
    metaArtist: [
      "define",
      { sourceInterval: [247, 321] },
      null,
      [],
      [
        "seq",
        { sourceInterval: [260, 321] },
        [
          "app",
          { sourceInterval: [260, 286] },
          "caseInsensitive",
          [["terminal", { sourceInterval: [276, 285] }, "artist:"]],
        ],
        [
          "star",
          { sourceInterval: [287, 297] },
          ["app", { sourceInterval: [287, 296] }, "spaceNoNL", []],
        ],
        ["app", { sourceInterval: [298, 313] }, "metaArtistValue", []],
        ["app", { sourceInterval: [314, 321] }, "newline", []],
      ],
    ],
    metaYear: [
      "define",
      { sourceInterval: [324, 398] },
      null,
      [],
      [
        "seq",
        { sourceInterval: [337, 398] },
        [
          "app",
          { sourceInterval: [337, 361] },
          "caseInsensitive",
          [["terminal", { sourceInterval: [353, 360] }, "year:"]],
        ],
        [
          "star",
          { sourceInterval: [364, 374] },
          ["app", { sourceInterval: [364, 373] }, "spaceNoNL", []],
        ],
        ["app", { sourceInterval: [375, 388] }, "metaYearValue", []],
        ["app", { sourceInterval: [391, 398] }, "newline", []],
      ],
    ],
    metaSig: [
      "define",
      { sourceInterval: [401, 475] },
      null,
      [],
      [
        "seq",
        { sourceInterval: [414, 475] },
        [
          "app",
          { sourceInterval: [414, 437] },
          "caseInsensitive",
          [["terminal", { sourceInterval: [430, 436] }, "sig:"]],
        ],
        [
          "star",
          { sourceInterval: [441, 451] },
          ["app", { sourceInterval: [441, 450] }, "spaceNoNL", []],
        ],
        ["app", { sourceInterval: [452, 464] }, "metaSigValue", []],
        ["app", { sourceInterval: [468, 475] }, "newline", []],
      ],
    ],
    metaKey: [
      "define",
      { sourceInterval: [478, 552] },
      null,
      [],
      [
        "seq",
        { sourceInterval: [491, 552] },
        [
          "app",
          { sourceInterval: [491, 514] },
          "caseInsensitive",
          [["terminal", { sourceInterval: [507, 513] }, "key:"]],
        ],
        [
          "star",
          { sourceInterval: [518, 528] },
          ["app", { sourceInterval: [518, 527] }, "spaceNoNL", []],
        ],
        ["app", { sourceInterval: [529, 541] }, "metaKeyValue", []],
        ["app", { sourceInterval: [545, 552] }, "newline", []],
      ],
    ],
    metaTitleValue: [
      "define",
      { sourceInterval: [556, 589] },
      null,
      [],
      [
        "plus",
        { sourceInterval: [574, 589] },
        [
          "seq",
          { sourceInterval: [575, 587] },
          [
            "not",
            { sourceInterval: [575, 583] },
            ["app", { sourceInterval: [576, 583] }, "newline", []],
          ],
          ["app", { sourceInterval: [584, 587] }, "any", []],
        ],
      ],
    ],
    metaArtistValue: [
      "define",
      { sourceInterval: [592, 625] },
      null,
      [],
      [
        "plus",
        { sourceInterval: [610, 625] },
        [
          "seq",
          { sourceInterval: [611, 623] },
          [
            "not",
            { sourceInterval: [611, 619] },
            ["app", { sourceInterval: [612, 619] }, "newline", []],
          ],
          ["app", { sourceInterval: [620, 623] }, "any", []],
        ],
      ],
    ],
    metaYearValue: [
      "define",
      { sourceInterval: [628, 661] },
      null,
      [],
      [
        "plus",
        { sourceInterval: [646, 661] },
        [
          "seq",
          { sourceInterval: [647, 659] },
          [
            "not",
            { sourceInterval: [647, 655] },
            ["app", { sourceInterval: [648, 655] }, "newline", []],
          ],
          ["app", { sourceInterval: [656, 659] }, "any", []],
        ],
      ],
    ],
    metaSigValue: [
      "define",
      { sourceInterval: [664, 697] },
      null,
      [],
      [
        "plus",
    ...
    metaKeyValue: [
      "define",
      { sourceInterval: [700, 733] },
      null,
      [],
      [
        "plus",
        { sourceInterval: [718, 733] },
        [
          "seq",
          { sourceInterval: [719, 731] },
          [
            "not",
            { sourceInterval: [719, 727] },
            ["app", { sourceInterval: [720, 727] }, "newline", []],
          ],
          ["app", { sourceInterval: [728, 731] }, "any", []],
        ],
      ],
    ],
    Barline: [
      "define",
      { sourceInterval: [737, 830] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [751, 830] },
        ["terminal", { sourceInterval: [753, 759] }, ":||:"],
        ["terminal", { sourceInterval: [766, 772] }, ":1||"],
        ["terminal", { sourceInterval: [779, 785] }, ":2||"],
        ["terminal", { sourceInterval: [792, 797] }, ":||"],
        ["terminal", { sourceInterval: [804, 809] }, "||:"],
        ["terminal", { sourceInterval: [816, 820] }, "||"],
        ["terminal", { sourceInterval: [827, 830] }, "|"],
      ],
    ],
    RepeatPreviousChord: [
      "define",
      { sourceInterval: [834, 896] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [860, 896] },
        ["terminal", { sourceInterval: [862, 865] }, "-"],
        ["terminal", { sourceInterval: [872, 875] }, "%"],
        ["terminal", { sourceInterval: [882, 885] }, "/"],
        ["terminal", { sourceInterval: [892, 896] }, "𝄎"],
      ],
    ],
    Chord: [
      "define",
      { sourceInterval: [900, 938] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [908, 938] },
        ["app", { sourceInterval: [908, 916] }, "ChordExp", []],
        ["app", { sourceInterval: [919, 938] }, "RepeatPreviousChord", []],
      ],
    ],
  },
]);
