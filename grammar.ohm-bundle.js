...
result.Song = makeRecipe([
  ...
  "ChordExp",
  {
    ...
    Barline: [
      "define",
      { sourceInterval: [1048, 1141] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [1062, 1141] },
        ["terminal", { sourceInterval: [1064, 1070] }, ":||:"],
        ["terminal", { sourceInterval: [1077, 1083] }, ":1||"],
        ["terminal", { sourceInterval: [1090, 1096] }, ":2||"],
        ["terminal", { sourceInterval: [1103, 1108] }, ":||"],
        ["terminal", { sourceInterval: [1115, 1120] }, "||:"],
        ["terminal", { sourceInterval: [1127, 1131] }, "||"],
        ["terminal", { sourceInterval: [1138, 1141] }, "|"],
      ],
    ],
    RepeatPreviousChord: [
      "define",
      { sourceInterval: [1145, 1207] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [1171, 1207] },
        ["terminal", { sourceInterval: [1173, 1176] }, "-"],
        ["terminal", { sourceInterval: [1183, 1186] }, "%"],
        ["terminal", { sourceInterval: [1193, 1196] }, "/"],
        ["terminal", { sourceInterval: [1203, 1207] }, "𝄎"],
      ],
    ],
    Chord: [
      "define",
      { sourceInterval: [1211, 1249] },
      null,
      [],
      [
        "alt",
        { sourceInterval: [1219, 1249] },
        ["app", { sourceInterval: [1219, 1227] }, "ChordExp", []],
        ["app", { sourceInterval: [1230, 1249] }, "RepeatPreviousChord", []],
      ],
    ],
  },
]);
