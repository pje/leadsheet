...
Deno.test(chordColor.name, async (t) => {
  const cases = new Map<string, ChordQuality | undefined>([
    ["C7", QualityDominant],
    ["C9", QualityDominant],
    ["C11", QualityDominant],
    ["C13", QualityDominant],
    ["C7alt", QualityDominant],
    ["C ", QualityMajor],
    ["C", QualityMajor],
    ["CM", QualityMajor],
    ["C6", QualityMajor],
    ...
    ["Cm11", QualityMinor],
    ["Cm13", QualityMinor],
    ["Cm11#13(no5)", QualityMinor],
    ["C5", QualityPower],
    ["Csus", QualitySuspended],
    ["Csus2", QualitySuspended],
    ["Csus4", QualitySuspended],
    ["Cdim", QualityDiminished],
    ["Co", QualityDiminished],
    ["Cdim7", QualityDiminished],
    ["Caug", QualityAugmented],
    ["C+", QualityAugmented],
    ["C𝄫minMaj9#11(sus4)(no13)(no 5)(♯¹¹)/E", QualityMinorMajor],
  ]);
